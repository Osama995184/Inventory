...
//    public void searchProductByNameFromDB_currentItems() {
//        ObservableList<productData> searchResults = FXCollections.observableArrayList();
//        String searchText = currentStockBalance_Search.getText() != null ? currentStockBalance_Search.getText().trim() : "";
//        String type = itemTypeListSearch_currentStockBalance.getSelectionModel().getSelectedItem();
//        String warehouse = searchWarehouseList_currentStockBalance.getSelectionModel().getSelectedItem();
//
//        StringBuilder sql = new StringBuilder("SELECT * FROM product WHERE 1=1");
...
//            sql.append(" AND (model LIKE ? OR CAST(id AS TEXT) LIKE ? OR msize LIKE ? OR suppliers LIKE ? OR CAST(invoicesID AS TEXT) LIKE ?)");
//            for (int i = 0; i < 5; i++) {
...
//            }
//
//            currentStockBalanceTable.setItems(searchResults);
//
//        } catch (SQLException e) {
//            al.showAlert("خطأ", "حدث خطأ أثناء تحميل الاصناف", Alert.AlertType.ERROR);
//            e.printStackTrace();
...
//
//    public void searchProductByNameFromDB_movementForm() {
//        ObservableList<productData> searchResults = FXCollections.observableArrayList();
//        String searchText = SearchItems_itemsMovementForm.getText() != null ? currentStockBalance_Search.getText().trim() : "";
//        String type = itemTypeList_itemsMovementForm.getSelectionModel().getSelectedItem();
//        String warehouse = warehouseList_itemsMovementForm.getSelectionModel().getSelectedItem();
//
//        StringBuilder sql = new StringBuilder("SELECT * FROM product WHERE 1=1");
