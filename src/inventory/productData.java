...
//    public productData(int id, String model, Double mNumberavailable, Double wholesalePrice, Double realPrice, String type
//            , int soldNo, String suppliers, int invoicesID, String wareHouse,String color,String size,String unit) {
//        this.id = id;
//        this.model = model;
...
//    }
    ...
    public productData(int id, String model, Double mNumberavailable, Double wholesalePrice, Double realPrice, String type
            , int soldNo, String wareHouse,String color,String size,String unit) {
        this.id = id;
        this.model = model;
        this.wholesalePrice = wholesalePrice;
        this.realPrice = realPrice;
    ...
    public productData(int id, String model, Double mNumberavailable, Double wholesalePrice, Double realPrice, String type, int soldNo) {
        this.id = id;
        this.model = model;
        this.wholesalePrice = wholesalePrice;
        this.realPrice = realPrice;
